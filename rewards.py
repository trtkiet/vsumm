...
def compute_reward(seq, actions, ignore_far_sim=False, temp_dist_thre=20, use_gpu=False):
    """
    ...
    Args:
        ...
        ignore_far_sim (bool): whether to ignore temporally distant similarity (default: False)
